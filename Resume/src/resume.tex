...
\documentclass[11pt, a4paper,final]{russell}
...
\mobile{+91 89276 86156}
\email{Dhiman.Sarkar.Academics@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{https://DhimanSarkar.github.io/} 
\github{github.com/DhimanSarkar}
\linkedin{linkedin.com/in/Dhiman-Sarkar}
% \gitlab{gitlab-id}
...
\makecvfooter
{\today}
{\href{https://DhimanSarkar.github.io/myResume/index.html?pdfVersion=\ifdef{\pdfVersion}{\pdfVersion}{}}{\includegraphics[width=1in]{./versioncheckbutton.pdf}}}
{\thepage}
