...
%---------------------------------------------------------
  \cvskill
    ...
    {Embeded C, C, C++, C\#, .NET Core/Framework, MATLAB, GNU Octave, Python, HTML/CSS/JS, Batch/Bash Scripting, Networking, Hypervisor/Containerization [Proxmox, Docker].} % Skills
%---------------------------------------------------------
  \cvskill
    {Academic:} % Category
